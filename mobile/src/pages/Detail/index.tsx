...
function handleNavigatetoWhatsapp(){
  ...
  return(
    ...
    <View style = {styles.container}>
      ...
      <Text style = {styles.addressContent}> Teofilo Otoni / MG</Text>
        </View>
    </View>
   
    <View style = {styles.footer}>

       <RectButton style={styles.button} onPress ={handleNavigatetoWhatsapp}> 
       <View > 
          <Text> 
            <Icon name="whatsapp" color= "#FFF" size = {26}/> 
            </Text>
       </View>
